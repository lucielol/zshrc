...
PS1='╭%B%F{magenta}%n %B%F{blue} %f%b$(hostname)%f%b $(dir_icon) %B%F{red}%~%f%b${vcs_info_msg_0_}
╰$(if [[ $? == 0 ]]; then echo "%F{green}$"; else echo "%F{red}$"; fi)%f%b '
...
# pnpm
export PNPM_HOME="/home/luciel/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
# bun completions
[ -s "/home/luciel/.bun/_bun" ] && source "/home/luciel/.bun/_bun"
...
export PATH=$PATH:/home/luciel/.spicetify
export PATH="/home/luciel/.config/herd-lite/bin:$PATH"
export PHP_INI_SCAN_DIR="/home/luciel/.config/herd-lite/bin:$PHP_INI_SCAN_DIR"
